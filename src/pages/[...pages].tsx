...
export default function test() {
    return (
      <>
        <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8 w-full h-screen">
            <div className="text-center">
                <p className="text-3xl font-semibold text-indigo-600">404</p>
                <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-6xl">Page not found</h1>
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                    ...
                    <Link href="/contact-us" className="rounded-md text-sm font-semibold text-gray-900 px-3.5 py-2.5 border-[1px] border-solid border-gray-300">Contact support <span aria-hidden="true">&rarr;</span></Link>
                </div>
            </div>
        </main>
      </>
